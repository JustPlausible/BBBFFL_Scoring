...
def upgrade():
    op.create_table(
        ...
        sa.CheckConstraint(
            "lifecycle_state IN ('setup', 'active', 'completed')",
            name="ck_bbbffl_season_lifecycle",
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "rules_key",
            "version_number",
            name="uq_rules_season_key_version",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ondelete="RESTRICT",
            name="fk_competition_rules_same_season",
        ),
        sa.CheckConstraint(
            "stream_type IN ('ordinary', 'finals', 'superscore')",
            name="ck_competition_stream_type",
        ),
    )
