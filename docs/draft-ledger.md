...
of mutable names or subsequent roster ownership. A database trigger rejects
ordinary completed-result rewrites. Auditable correction and undo commands are
